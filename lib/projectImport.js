...
module.exports = {
    ...
    parseInput: function (xml, callback) {
        ...
        this.generateIoBObjects(fileObjectList, (error, result) => {
            callback(error, result);
        });
    },

    // generate the Groupaddress structure
    generateIoBObjects: function (fileObjectList, callback) {
        ...
        function processFile(err, objectList) {
            ...
            _.each(groupAddresses, function (groupAddress) {
                ...
                try {
                    ...
                    //unknown dpt, raw interface
                }

                // is there a scalar range? eg. DPT5.003 angle degrees (0=0, ff=360)
                if (!!(dptObj) && Object.prototype.hasOwnProperty.call(dptObj, 'subtype') && (dptObj.subtype) && dptObj.subtype.hasOwnProperty('scalar_range')) {
                ...
                const iobrokerObject = {
                    ...
                    common: {
                        desc: 'Basetype: ' +
                            (!(dptObj) || tools.isEmptyObject(dptObj) ? 'raw value' :
                                (
                                    ...
                                    ((Object.prototype.hasOwnProperty.call(dptObj, 'subtype') && (dptObj.subtype) && Object.prototype.hasOwnProperty.call(dptObj, 'desc')) ? (', Subtype: ' + dptObj.subtype.desc) : '')
                                )
                            ),
                        min: range[0],
                        max: range[1],
                        ...
                        unit: (!!(dptObj) && Object.prototype.hasOwnProperty.call(dptObj, 'subtype') && (dptObj.subtype) && Object.prototype.hasOwnProperty.call(dptObj, 'unit')) ? dptObj.subtype.unit : undefined,
                        write: true,
                    },
                    native: {
                        ...
                        dpt: dpt,
                        encoding: !!(dptObj) && Object.prototype.hasOwnProperty.call(dptObj, 'subtype') && (dptObj.subtype) ? (Object.prototype.hasOwnProperty.call(dptObj, 'enc') ? dptObj.subtype.enc : dptObj.basetype.enc) : undefined, //informative ,todo matcht zu common.states`? hat basetype enc?
                        force_encoding: (!!(dptObj) && Object.prototype.hasOwnProperty.call(dptObj, 'subtype') && (dptObj.subtype) && Object.prototype.hasOwnProperty.call(dptObj, 'subtype')) ? dptObj.subtype.force_encoding : undefined, //DPT16
                        signedness: !!(dptObj) && !tools.isEmptyObject(dptObj) ? (Object.prototype.hasOwnProperty.call(dptObj, 'signedness') ? dptObj.basetype.signedness : undefined) : undefined, //signed or unsigned or empty
